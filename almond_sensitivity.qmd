...
Submit as a group: a knitted Rmarkdown document that includes your workflow graph, paragraph , and your R files for almond yield and profit model
...
###unit_price... runif() for uniform distributions because we assume that price changes do to a variety of factors across many years
